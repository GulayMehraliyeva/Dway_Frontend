...
export default function ProfileScreen() {
  ...
  const [showAlarmSheet, setShowAlarmSheet] =
    useState(false);

  const [selectedAlarmSound, setSelectedAlarmSound] =
    useState("Standard alarm sound");

  const [showThemeSheet, setShowThemeSheet] =
    useState(false);
  ...
  const loadData = async () => {
    ...
    setPushNotifications(
      result.notifications.pushNotifications
    );

    setSelectedAlarmSound(
      result.notifications.alarmSound
    );
      ...
      >
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statCard}>
            <Text style={[styles.statNumber, { color: "#5E5CE6" }]}>
        ...
        <View style={styles.partnerCard}>
            ...
            <View style={styles.partnerContent}>
              <View style={styles.partnerTitleRow}>
                <Text style={styles.partnerTitle}>
                  {data.partners.headspace.title}
                </Text>
                <View style={styles.offerBadgeOrange}>
                  <Text style={styles.offerBadgeTextOrange}>
                    {data.partners.headspace.badge}
                  </Text>
                </View>
              </View>

              <Text style={styles.partnerSubOrange}>
                {data.partners.headspace.subtitle}
              </Text>

              <Text style={styles.partnerDescription}>
                {data.partners.headspace.description}
              </Text>
            </View>
          </View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Linking.openURL("https://www.headspace.com")
            }
          >
            <Text style={styles.partnerButtonTextOrange}>
              View Offer
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.partnerCard}>
          <View style={styles.partnerTop}>
            ...
            <View style={styles.partnerContent}>
              <View style={styles.partnerTitleRow}>
                <Text style={styles.partnerTitle}>
                  {data.partners.coursera.title}
                </Text>
                <View style={styles.offerBadgeBlue}>
                  <Text style={styles.offerBadgeTextBlue}>
                    {data.partners.coursera.badge}
                  </Text>
                </View>
              </View>

              <Text style={styles.partnerSubBlue}>
                {data.partners.coursera.subtitle}
              </Text>

              <Text style={styles.partnerDescription}>
                {data.partners.coursera.description}
              </Text>
            </View>
          </View>
          ...
          >
            <Text style={styles.partnerButtonTextBlue}>
              View Offer
            </Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  partnerButtonTextOrange: {
    fontSize: 16,
    fontWeight: "700",
    color: "#F97316",
  },

  partnerButtonTextBlue: {
    fontSize: 16,
    fontWeight: "700",
    color: "#0EA5E9",
  },
